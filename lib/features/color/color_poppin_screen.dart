...
import 'package:mb/core/utils/random_handler.dart';
...
class _ColorPoppinScreenState extends State<ColorPoppinScreen>
  ...
  void _changeColorAndPosition() {
    ...
    _popController.forward().then((_) {
      setState(() {
        _backgroundColor = RandomHandler.generateRandomColor();
        _randomFont = RandomHandler.getRandomFont();
        _buttonPosition = RandomHandler.generateRandomPosition(
