...
class ProjectEntity {
  ...
  ProjectEntity copyWith({
    ...
    List<Feature>? keyFeatures,
    List<Challenge>? challenges,
    List<FutureEnhancement>? futureEnhancements,
    ...
    return ProjectEntity(
      ...
      name: name ?? this.name,
      bannerBgColor: bannerBgColor ?? this.bannerBgColor,
      bannerType: bannerType ?? this.bannerType,
      bannerImagePath: bannerImagePath ?? this.bannerImagePath,
      bannerLottiePath: bannerLottiePath ?? this.bannerLottiePath,
      ...
      developmentTime: developmentTime ?? this.developmentTime,
      stats: stats ?? this.stats,
      teamMembers: teamMembers ?? this.teamMembers,
      keyFeatures: keyFeatures ?? this.keyFeatures,
      challenges: challenges ?? this.challenges,
      futureEnhancements: futureEnhancements ?? this.futureEnhancements,
